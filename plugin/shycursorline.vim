...
function! s:isLoadThisFile()
  if get(g:, 'loaded_shycursorline')             | return 0 | endif
  if v:progname[0] ==? 'g' || has('gui_running') | return 1 | endif
  if has('termguicolors') && &termguicolors      | return 1 | endif
  return 0
endfunction
